...
- ***Link headers***
  - [Gradle Settings](#gradle-settings)<br/>
  - [Console Codes](#console-codes)<br/>
  - [Permissions Settings](#permissions-settings)<br/>
  - [Main Code](#main-code)<br/>
...
```dart
flutter pub add bluetooth_classic 
```
...
...
  ...
  bluetooth_classic: ^0.0.1 ###### This is line
```
